...
public class Program {
    ...
    // Option 1 - Find the profile description for an existing account
    ...
    // Option 5 - Display all posts from a single account
    ...
    // Option 6 - Add a new post to account
    ...
    // Option 7 - Load a file of actions from disk and process it
